...
CANONICAL_ENCRYPTION_KEY = os.getenv("CANONICAL_ENCRYPTION_KEY", "")  # boundary 민감 payload 암호화용 키
CANONICAL_ENCRYPTION_KEY_ID = os.getenv("CANONICAL_ENCRYPTION_KEY_ID", "local-v1")
CANONICAL_ENCRYPTION_KEY_PATH = os.getenv("CANONICAL_ENCRYPTION_KEY_PATH", "")  # 비어 있으면 DB 옆 sidecar key 생성
